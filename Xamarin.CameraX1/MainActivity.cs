...
namespace CameraX
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        private Java.IO.File GetOutputDirectory()
        {
            ...
            //for the Android 10 or later, we just could save the image to the app storage path such as:"/data/user/0/com.companyname.camerax/files"
            var backingFilePath = System.Environment.GetFolderPath(System.Environment.SpecialFolder.Personal);
   

            var file = new Java.IO.File(backingFilePath, string.Empty); 
            file.Mkdirs();
            return file;
        }
    }
